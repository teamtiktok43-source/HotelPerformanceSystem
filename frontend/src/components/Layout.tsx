    ...
    <div className="app">
      ...
      <main className="main">
        <header>
          ...
          <div className="creator-credit" aria-label="Created by Mostafa Amer">Created by Mostafa Amer</div>
          <div className="header-actions">
            <NotificationsBell />
            <div className="user-pill"><b>{user.display_name}</b><span>{user.role}</span></div>
          </div>
        </header>
        {children}
      </main>
